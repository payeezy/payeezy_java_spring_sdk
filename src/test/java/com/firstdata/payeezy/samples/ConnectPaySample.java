...
public class ConnectPaySample implements CommandLineRunner{

    public static void main(String [] args){
        SpringApplication.run(ConnectPaySample.class);
    }
    ...
    public void run(String... strings) throws Exception {
        ...
        try{
            PayeezyResponse payeezyResponse = payeezyClientHelper.enrollInConnectPay(enrollmentRequest);
       ...
       /*     enrollmentRequest.setEnrollmentId(enrollmentResponse.getEnrollmentId());
            ...
            PayeezyResponse updateResponse =  payeezyClientHelper.updateConnectPayEnrollment(enrollmentRequest);
            ...
            PayeezyResponse closeResponse = payeezyClientHelper.closeConnectPayEnrollment(enrollmentRequest);
